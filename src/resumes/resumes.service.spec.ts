...
import { Resume, ResumeDocument, ResumeSchema } from './schemas/resume.schema';
...
describe('ResumesService', () => {
  ...
  it('should insert a new resume', async () => {
    ...
    jest.spyOn(usersService, 'getUser').mockResolvedValue(premiumUser);
    await service.create(createResumeDtoArray[0], authUser);
